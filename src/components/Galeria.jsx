...
export default function Home() {
  ...
  return (
    <div className="galeria grid-columns-5 p-3 animate__animated animate__flipInY">
      {gallery.map((item, i) => (
        <div className="foto" style={{ backgroundImage: `url(${item.src})` }} key={i}>

          <svg width="40px" viewBox="0 0 24 24" onClick={() => setFavourite(item.id)}>
            <path
